                        ...
                        <div class="col-xl-2 col-lg-2 col-md-3 col-sm-4 col-5">
                            <div class="logo mt-50 mb-50 transition5">
                                <a class="header-logo" href="index.html"><img
                                        src="<?php echo e(asset('front/assets')); ?>/images/logo/logo.png" alt="THAMES"></a>
                            </div>
                        </div><!-- /col -->
                        <div
    ...
    <!--  header-area-end  -->
<?php /**PATH /home/mohamed-khater/Documents/projects/stc/active/bawarq.org/resources/views/front/layouts/partials/navbar.blade.php ENDPATH**/ ?>