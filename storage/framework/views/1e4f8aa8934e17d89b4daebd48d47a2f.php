<?php $__env->startSection('title', 'Bawarq'); ?>
    ...
    <div id="about" class="about-area over-hidden">
        <div class="about-content-wrapper about-margin mt-170 mb-110 position-relative">
                        ...
                        <div class="about-content position-relative mb-50">
                            ...
                            <div
                                ...
                                <div class="signature pt-12 pr-45">
                                    <img src="<?php echo e(asset('front/assets')); ?>/images/about/signature.png" alt="signature">
                                </div>
            ...
            <div class="about-icon position-absolute d-none d-md-inline-block z-index1 zoom-animation">
                <img src="<?php echo e(asset('front/assets')); ?>/images/shape/content-shape2.png" alt="about shape 2">
...
[$__name, $__params] = $__split('front.component.tools');

$__html = app('livewire')->mount($__name, $__params, 'lw-1202880199-0', $__slots ?? [], get_defined_vars());
...
<?php echo $__env->make('front.layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/mohamed-khater/Documents/projects/stc/active/bawarq.org/resources/views/front/pages/index.blade.php ENDPATH**/ ?>